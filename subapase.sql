...
CREATE TABLE public.quiz_models (
    ...
    teacher_id BIGINT REFERENCES public.teachers(id) ON DELETE SET NULL, -- من أنشأ النموذج
    title TEXT NOT NULL,
...
-- 4. جدول الأسئلة (معدل لدعم خيارات الصور وإعادة الترتيب)
...
CREATE TABLE public.phone (
    ...
    verification_code VARCHAR(6), -- كود التحقق المرسل على واتساب
    is_verified BOOLEAN DEFAULT FALSE NOT NULL, -- حالة التحقق من الرقم
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW(),
